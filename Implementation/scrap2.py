            ...
            if os.path.isdir(method): 
                for ooo in os.listdir(method):
                    ...
                    if os.path.isdir(Eq): 
                        ...
                        f.write("time gtimeout 300 java -Djava.library.path=jpf-git/jpf-symbc/lib -Xmx20G -Xms16G -jar target/artifacts/Implementation_jar/Implementation.jar --path1 " + versions[1] + " --path2 " + versions[0] + " --tool A --s coral --b 3 --H R\n")
                        f.write("echo \"###################################################################################################\" \n")
                        #f.write("START java -Djava.library.path=jpf-git/jpf-symbc/lib -Xmx20G -Xms16G -jar target/artifacts/Implementation_jar/Implementation.jar --path1 "+ versions[1] + " --path2 " + versions[0] + " --tool A --s coral --b 3 & TIMEOUT /T 300 \n")
                        f.write("time gtimeout 300 java -Djava.library.path=jpf-git/jpf-symbc/lib -Xmx20G -Xms16G -jar target/artifacts/Implementation_jar/Implementation.jar --path1 " + versions[1] + " --path2 " + versions[0] + " --tool A --s coral --b 3 --H H3\n")
                        f.write("echo \"###################################################################################################\" \n")
                        #f.write("START java -Djava.library.path=jpf-git/jpf-symbc/lib -Xmx20G -Xms16G -jar target/artifacts/Implementation_jar/Implementation.jar --path1 "+ versions[1] + " --path2 " + versions[0] + " --tool A --s coral --b 3 & TIMEOUT /T 300 \n")
                        f.write("time gtimeout 300 java -Djava.library.path=jpf-git/jpf-symbc/lib -Xmx20G -Xms16G -jar target/artifacts/Implementation_jar/Implementation.jar --path1 " + versions[1] + " --path2 " + versions[0] + " --tool A --s coral --b 3 --H H123\n")
                        print(Eq)
f.close()
print(index)  
